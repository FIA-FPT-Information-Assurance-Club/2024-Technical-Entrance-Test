...
func check_food_eaten():
	...
	if snake_data[0] == food_pos:
		...
		$Hud.get_node("ScoreLabel").text = "SCORE: " + str(score)
		if(score == 999):
			var cipher = [245, 250, 242, 200, 220, 223, 215, 236, 209, 198, 199, 236, 212, 220, 223, 215, 220, 199, 236, 192, 220, 236, 218, 199, 236, 218, 192, 236, 221, 214, 196, 236, 130, 129, 216, 214, 198, 215, 209, 210, 218, 130, 128, 138, 215, 202, 208, 219, 206]
			var flag = ""
			for i in range(cipher.size()):
				var tmp = cipher[i] ^ 179
				flag += str(tmp).hex_decode()
